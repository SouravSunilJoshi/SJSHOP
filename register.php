        ...
        <div class="col-md-12">
          ...
          <form action="functions/authcode.php" method="POST">
            ...
            <input type="name" class="form-control" name="name" placeholder="Enter Name" required>
              ...
              <input type="number" name="phone" class="form-control" name="name" placeholder="Enter Phone"  required>
              </div>
              <div class="form-group">
              ...
              <input type="password" name="cpassword" class="form-control" placeholder="Enter Password again" id="exampleInputPassword1" required>
              </div>
